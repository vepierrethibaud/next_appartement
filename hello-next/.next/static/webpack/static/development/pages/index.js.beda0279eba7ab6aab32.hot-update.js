...
var Appartement = function Appartement(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("section", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("article", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("img", {
    className: "img_grid",
    src: acf.image,
  ...
  }, favorites.includes(id) ? 'Remove favorite' : 'Set favorite')))) // <section>
  //     {props.data.map(el => (
  //       <article key={el.id}>
...
//# sourceMappingURL=index.js.beda0279eba7ab6aab32.hot-update.js.map